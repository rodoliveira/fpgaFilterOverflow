...
#define FRACTIONAL_BITS 10L

#define a0  FIXED(1,  INTEGER_BITS,FRACTIONAL_BITS)
#define a1  FIXED(-0.369527377351241,  INTEGER_BITS,FRACTIONAL_BITS)
#define a2  FIXED(0.195815712655833,  INTEGER_BITS,FRACTIONAL_BITS)
#define b0  FIXED(0.206572083826148,  INTEGER_BITS,FRACTIONAL_BITS)
#define b1  FIXED(0.413144167652296,  INTEGER_BITS,FRACTIONAL_BITS)
#define b2  FIXED(0.206572083826148,  INTEGER_BITS,FRACTIONAL_BITS)
...
#define B {b0, b1, b2}
#define A {a0, a1, a2}
#define UPPER_INPUT_LIMIT FIXED(3.42429686113535,   INTEGER_BITS,FRACTIONAL_BITS)
#define LOWER_INPUT_LIMIT FIXED(-3.42429686113535,   INTEGER_BITS,FRACTIONAL_BITS)
