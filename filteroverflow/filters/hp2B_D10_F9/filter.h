...
#define b0  FIXED(0.391335772501769,  INTEGER_BITS,FRACTIONAL_BITS)
#define b1  FIXED(-0.782671545003537,  INTEGER_BITS,FRACTIONAL_BITS)
#define b2  FIXED(0.391335772501769,  INTEGER_BITS,FRACTIONAL_BITS)
...
#define B {b0, b1, b2}
#define A {a0, a1, a2}
#define UPPER_INPUT_LIMIT FIXED(2.98985935223996,   INTEGER_BITS,FRACTIONAL_BITS)
#define LOWER_INPUT_LIMIT FIXED(-2.98985935223996,   INTEGER_BITS,FRACTIONAL_BITS)
