...
module cycloneV_soc_mm_interconnect_0 (
		...
		input  wire        fut_0_reset_sink_reset_bridge_in_reset_reset,                       //                       fut_0_reset_sink_reset_bridge_in_reset.reset
		...
		input  wire [31:0] fut_0_avalon_master_address,                                        //                                          fut_0_avalon_master.address
		output wire        fut_0_avalon_master_waitrequest,                                    //                                                             .waitrequest
		input  wire        fut_0_avalon_master_write,                                          //                                                             .write
		input  wire [15:0] fut_0_avalon_master_writedata,                                      //                                                             .writedata
	...
	wire          fut_0_avalon_master_translator_avalon_universal_master_0_waitrequest;   // fut_0_avalon_master_agent:av_waitrequest -> fut_0_avalon_master_translator:uav_waitrequest
	wire   [15:0] fut_0_avalon_master_translator_avalon_universal_master_0_readdata;      // fut_0_avalon_master_agent:av_readdata -> fut_0_avalon_master_translator:uav_readdata
	wire          fut_0_avalon_master_translator_avalon_universal_master_0_debugaccess;   // fut_0_avalon_master_translator:uav_debugaccess -> fut_0_avalon_master_agent:av_debugaccess
	wire   [31:0] fut_0_avalon_master_translator_avalon_universal_master_0_address;       // fut_0_avalon_master_translator:uav_address -> fut_0_avalon_master_agent:av_address
	wire          fut_0_avalon_master_translator_avalon_universal_master_0_read;          // fut_0_avalon_master_translator:uav_read -> fut_0_avalon_master_agent:av_read
	wire    [1:0] fut_0_avalon_master_translator_avalon_universal_master_0_byteenable;    // fut_0_avalon_master_translator:uav_byteenable -> fut_0_avalon_master_agent:av_byteenable
	wire          fut_0_avalon_master_translator_avalon_universal_master_0_readdatavalid; // fut_0_avalon_master_agent:av_readdatavalid -> fut_0_avalon_master_translator:uav_readdatavalid
	wire          fut_0_avalon_master_translator_avalon_universal_master_0_lock;          // fut_0_avalon_master_translator:uav_lock -> fut_0_avalon_master_agent:av_lock
	wire          fut_0_avalon_master_translator_avalon_universal_master_0_write;         // fut_0_avalon_master_translator:uav_write -> fut_0_avalon_master_agent:av_write
	wire   [15:0] fut_0_avalon_master_translator_avalon_universal_master_0_writedata;     // fut_0_avalon_master_translator:uav_writedata -> fut_0_avalon_master_agent:av_writedata
	wire    [1:0] fut_0_avalon_master_translator_avalon_universal_master_0_burstcount;    // fut_0_avalon_master_translator:uav_burstcount -> fut_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                      // rsp_mux:src_valid -> fut_0_avalon_master_agent:rp_valid
	wire   [90:0] rsp_mux_src_data;                                                       // rsp_mux:src_data -> fut_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                      // fut_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                    // rsp_mux:src_channel -> fut_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                              // rsp_mux:src_startofpacket -> fut_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                // rsp_mux:src_endofpacket -> fut_0_avalon_master_agent:rp_endofpacket
	...
	wire          fut_0_avalon_master_agent_cp_valid;                                     // fut_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire   [90:0] fut_0_avalon_master_agent_cp_data;                                      // fut_0_avalon_master_agent:cp_data -> router:sink_data
	wire          fut_0_avalon_master_agent_cp_ready;                                     // router:sink_ready -> fut_0_avalon_master_agent:cp_ready
	wire          fut_0_avalon_master_agent_cp_startofpacket;                             // fut_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          fut_0_avalon_master_agent_cp_endofpacket;                               // fut_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire   [90:0] cmd_mux_src_data;                                                       // cmd_mux:src_data -> hps_0_f2h_sdram0_data_cmd_width_adapter:in_data
	...
	wire  [108:0] hps_0_f2h_sdram0_data_cmd_width_adapter_src_data;                       // hps_0_f2h_sdram0_data_cmd_width_adapter:out_data -> hps_0_f2h_sdram0_data_agent:cp_data
	...
	wire  [108:0] router_001_src_data;                                                    // router_001:src_data -> hps_0_f2h_sdram0_data_rsp_width_adapter:in_data
	...
	wire   [90:0] hps_0_f2h_sdram0_data_rsp_width_adapter_src_data;                       // hps_0_f2h_sdram0_data_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	) fut_0_avalon_master_translator (
		.clk                    (clk_0_clk_clk),                                                          //                       clk.clk
		.reset                  (fut_0_reset_sink_reset_bridge_in_reset_reset),                           //                     reset.reset
		.uav_address            (fut_0_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (fut_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (fut_0_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (fut_0_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (fut_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (fut_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (fut_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (fut_0_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (fut_0_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (fut_0_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (fut_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (fut_0_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (fut_0_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_write               (fut_0_avalon_master_write),                                              //                          .write
		.av_writedata           (fut_0_avalon_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) fut_0_avalon_master_agent (
		.clk                   (clk_0_clk_clk),                                                          //       clk.clk
		.reset                 (fut_0_reset_sink_reset_bridge_in_reset_reset),                           // clk_reset.reset
		.av_address            (fut_0_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (fut_0_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (fut_0_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (fut_0_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (fut_0_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (fut_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (fut_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (fut_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (fut_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (fut_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (fut_0_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (fut_0_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (fut_0_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (fut_0_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (fut_0_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (fut_0_avalon_master_agent_cp_ready),                                     //          .ready
	...
	cycloneV_soc_mm_interconnect_0_router router (
		.sink_ready         (fut_0_avalon_master_agent_cp_ready),           //      sink.ready
		.sink_valid         (fut_0_avalon_master_agent_cp_valid),           //          .valid
		.sink_data          (fut_0_avalon_master_agent_cp_data),            //          .data
		.sink_startofpacket (fut_0_avalon_master_agent_cp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (fut_0_avalon_master_agent_cp_endofpacket),     //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (fut_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cycloneV_soc_mm_interconnect_0_router_001 router_001 (
	...
	cycloneV_soc_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
