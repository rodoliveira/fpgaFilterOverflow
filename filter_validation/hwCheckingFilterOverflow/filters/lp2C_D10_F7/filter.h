...
#define a1  FIXED(-0.351350980988748,  INTEGER_BITS,FRACTIONAL_BITS)
#define a2  FIXED(0.329655910298801,  INTEGER_BITS,FRACTIONAL_BITS)
#define b0  FIXED(0.217978796507113,  INTEGER_BITS,FRACTIONAL_BITS)
#define b1  FIXED(0.435957593014226,  INTEGER_BITS,FRACTIONAL_BITS)
#define b2  FIXED(0.217978796507113,  INTEGER_BITS,FRACTIONAL_BITS)
...
#define B {b0, b1, b2}
#define A {a0, a1, a2}
#define UPPER_INPUT_LIMIT FIXED(2.99774290208491,   INTEGER_BITS,FRACTIONAL_BITS)
#define LOWER_INPUT_LIMIT FIXED(-2.99774290208491,   INTEGER_BITS,FRACTIONAL_BITS)
