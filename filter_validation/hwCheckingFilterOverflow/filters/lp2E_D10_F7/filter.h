...
#define FRACTIONAL_BITS 7L

#define a0  FIXED(1,  INTEGER_BITS,FRACTIONAL_BITS)
#define a1  FIXED(-0.349103753295854,  INTEGER_BITS,FRACTIONAL_BITS)
#define a2  FIXED(0.333004208990974,  INTEGER_BITS,FRACTIONAL_BITS)
#define b0  FIXED(0.223429002475895,  INTEGER_BITS,FRACTIONAL_BITS)
#define b1  FIXED(0.430044199216705,  INTEGER_BITS,FRACTIONAL_BITS)
#define b2  FIXED(0.223429002475895,  INTEGER_BITS,FRACTIONAL_BITS)
...
#define B {b0, b1, b2}
#define A {a0, a1, a2}
#define UPPER_INPUT_LIMIT FIXED(2.98591172678659,   INTEGER_BITS,FRACTIONAL_BITS)
#define LOWER_INPUT_LIMIT FIXED(-2.98591172678659,   INTEGER_BITS,FRACTIONAL_BITS)
