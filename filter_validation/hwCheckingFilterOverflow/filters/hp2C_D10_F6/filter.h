...
#define a1  FIXED(-0.473364104641033,  INTEGER_BITS,FRACTIONAL_BITS)
#define a2  FIXED(0.343018702269697,  INTEGER_BITS,FRACTIONAL_BITS)
#define b0  FIXED(0.404713220167298,  INTEGER_BITS,FRACTIONAL_BITS)
#define b1  FIXED(-0.809426440334597,  INTEGER_BITS,FRACTIONAL_BITS)
#define b2  FIXED(0.404713220167298,  INTEGER_BITS,FRACTIONAL_BITS)
...
#define B {b0, b1, b2}
#define A {a0, a1, a2}
#define UPPER_INPUT_LIMIT FIXED(2.74985591580643,   INTEGER_BITS,FRACTIONAL_BITS)
#define LOWER_INPUT_LIMIT FIXED(-2.74985591580643,   INTEGER_BITS,FRACTIONAL_BITS)
